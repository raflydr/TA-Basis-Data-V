...
public class main {
    ...
    private static void viewMengelola(){
        ...
        for(MengelolaEntity index : mengelolaEntities) {
            ...
            System.out.println("Bayar : " + index.getBayar());
            System.out.println("Kembalian : " + index.getKembalian());
    ...
    private static void viewDetailTransaksi(){
        //ArrayList<MengelolaEntity> mengelolaEntities = mengelolaController.getDetail();
        ArrayList<MengelolaEntity> mengelolaEntities = mengelolaController.getDetailTransaksi();
        ArrayList<TransaksiEntity> transaksiEntities = transaksiController.getTransaksi();
        if(mengelolaEntities.size() == 0) {
            System.out.println("Tidak Ada Data");
            return;
    ...
    private static void insertDetail(){
        ...
        mengelolaEntity.setNama_jajan(input.next());
        System.out.print("masukkan id transaksi : ");
        mengelolaEntity.setId_transaksi(input.nextInt());
        System.out.print("masukkan qty jajan : ");
        mengelolaEntity.setQty_jajan(input.nextInt());
        System.out.print("bayar : ");
        mengelolaEntity.setBayar(input.nextFloat());


        mengelolaController.updateStok(mengelolaEntity.getQty_jajan(), mengelolaEntity.getNama_jajan());
        mengelolaController.insertDetail(mengelolaEntity.getNama_jajan(), mengelolaEntity.getId_transaksi(), mengelolaEntity.getQty_jajan(),
                mengelolaEntity.getBayar());

        System.out.println("");
        mengelolaController.viewMengelola(mengelolaEntity.getId_transaksi());
    }
}
